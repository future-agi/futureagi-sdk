...
func (o *ApiErrorResponse) GetStatus() bool {
...
func (o *ApiErrorResponse) GetStatusOk() (*bool, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *ApiErrorResponse) SetStatus(v bool) {
	o.Status = &v
}
...
func (o *ApiErrorResponse) SetTypeNil() {
	o.Type.Set(nil)
}

// UnsetType ensures that no value is present for Type, not even an explicit nil
func (o *ApiErrorResponse) UnsetType() {
	o.Type.Unset()
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ApiErrorResponse) GetCodeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ApiErrorResponse) SetCode(v string) {
	o.Code.Set(&v)
}

// SetCodeNil sets the value for Code to be an explicit nil
func (o *ApiErrorResponse) SetCodeNil() {
	o.Code.Set(nil)
}

// UnsetCode ensures that no value is present for Code, not even an explicit nil
func (o *ApiErrorResponse) UnsetCode() {
	o.Code.Unset()
}
...
func (o *ApiErrorResponse) SetDetailNil() {
	o.Detail.Set(nil)
}

// UnsetDetail ensures that no value is present for Detail, not even an explicit nil
func (o *ApiErrorResponse) UnsetDetail() {
	o.Detail.Unset()
}

// GetResult returns the Result field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ApiErrorResponse) GetResult() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ApiErrorResponse) GetResultOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ApiErrorResponse) HasResult() bool {
...
func (o *ApiErrorResponse) SetResult(v string) {
	o.Result.Set(&v)
}

// SetResultNil sets the value for Result to be an explicit nil
func (o *ApiErrorResponse) SetResultNil() {
	o.Result.Set(nil)
}

// UnsetResult ensures that no value is present for Result, not even an explicit nil
func (o *ApiErrorResponse) UnsetResult() {
	o.Result.Unset()
}
...
func (o *ApiErrorResponse) SetMessageNil() {
	o.Message.Set(nil)
}

// UnsetMessage ensures that no value is present for Message, not even an explicit nil
func (o *ApiErrorResponse) UnsetMessage() {
	o.Message.Unset()
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ApiErrorResponse) GetAttrOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ApiErrorResponse) HasAttr() bool {
...
func (o *ApiErrorResponse) SetAttr(v string) {
	o.Attr.Set(&v)
}

// SetAttrNil sets the value for Attr to be an explicit nil
func (o *ApiErrorResponse) SetAttrNil() {
	o.Attr.Set(nil)
}

// UnsetAttr ensures that no value is present for Attr, not even an explicit nil
func (o *ApiErrorResponse) UnsetAttr() {
	o.Attr.Unset()
}

// GetDetails returns the Details field value if set, zero value otherwise.
func (o *ApiErrorResponse) GetDetails() map[string][]string {
...
// and a boolean to check if the value has been set.
func (o *ApiErrorResponse) GetDetailsOk() (*map[string][]string, bool) {
	if o == nil || IsNil(o.Details) {
		return nil, false
	}
...
func (o *ApiErrorResponse) SetDetails(v map[string][]string) {
	o.Details = &v
}
