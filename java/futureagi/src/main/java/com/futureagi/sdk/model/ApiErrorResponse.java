...
@JsonPropertyOrder({
  ...
  ApiErrorResponse.JSON_PROPERTY_TYPE,
  ApiErrorResponse.JSON_PROPERTY_CODE,
  ApiErrorResponse.JSON_PROPERTY_DETAIL,
  ApiErrorResponse.JSON_PROPERTY_RESULT,
  ApiErrorResponse.JSON_PROPERTY_MESSAGE,
  ApiErrorResponse.JSON_PROPERTY_ERROR,
  ApiErrorResponse.JSON_PROPERTY_ATTR,
  ApiErrorResponse.JSON_PROPERTY_DETAILS
})
...
public class ApiErrorResponse {
  ...
  public ApiErrorResponse status(@javax.annotation.Nullable Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public ApiErrorResponse type(@javax.annotation.Nullable TypeEnum type) {
  ...
  public ApiErrorResponse code(@javax.annotation.Nullable String code) {
  ...
  public ApiErrorResponse detail(@javax.annotation.Nullable String detail) {
  ...
  public ApiErrorResponse result(@javax.annotation.Nullable String result) {
  ...
  public ApiErrorResponse error(@javax.annotation.Nullable String error) {
  ...
  public ApiErrorResponse attr(@javax.annotation.Nullable String attr) {
  ...
  public ApiErrorResponse details(@javax.annotation.Nullable Map<String, List<String>> details) {
    this.details = details;
    return this;
  }

  public ApiErrorResponse putDetailsItem(String key, List<String> detailsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, apiErrorResponse.status) &&
        equalsNullable(this.type, apiErrorResponse.type) &&
        equalsNullable(this.code, apiErrorResponse.code) &&
        equalsNullable(this.detail, apiErrorResponse.detail) &&
        equalsNullable(this.result, apiErrorResponse.result) &&
        equalsNullable(this.message, apiErrorResponse.message) &&
        equalsNullable(this.error, apiErrorResponse.error) &&
        equalsNullable(this.attr, apiErrorResponse.attr) &&
