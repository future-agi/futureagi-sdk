...
from ...models.queue_add_label_response import QueueAddLabelResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/annotation-queues/{id}/add-label/".format(
...
) -> ApiTextErrorResponse | ManagementAPIErrorResponse | QueueAddLabelResponse:
    if response.status_code == 200:
        response_200 = QueueAddLabelResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ApiTextErrorResponse | ManagementAPIErrorResponse | QueueAddLabelResponse]
    """
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
    body: QueueLabelRequest,
) -> ApiTextErrorResponse | ManagementAPIErrorResponse | QueueAddLabelResponse | None:
    """Add a label to an annotation queue.
    Labels apply to all sources in the queue's project (for default queues).
    Queue items are created lazily when someone actually annotates.
