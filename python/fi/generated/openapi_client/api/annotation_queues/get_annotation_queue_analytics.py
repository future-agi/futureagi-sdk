...
from ...models.queue_analytics_response import QueueAnalyticsResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/model-hub/annotation-queues/{id}/analytics/".format(
...
) -> ApiTextErrorResponse | ManagementAPIErrorResponse | QueueAnalyticsResponse:
    if response.status_code == 200:
        response_200 = QueueAnalyticsResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ApiTextErrorResponse | ManagementAPIErrorResponse | QueueAnalyticsResponse]
    """
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> ApiTextErrorResponse | ManagementAPIErrorResponse | QueueAnalyticsResponse | None:
    """Queue analytics: throughput, annotator performance, label distribution.
