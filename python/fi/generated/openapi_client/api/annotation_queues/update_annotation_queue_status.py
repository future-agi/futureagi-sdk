...
from ...models.queue_status_request import QueueStatusRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/annotation-queues/{id}/update-status/".format(
...
) -> ApiTextErrorResponse | ManagementAPIErrorResponse | QueueStatusResponse:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiTextErrorResponse | ManagementAPIErrorResponse | QueueStatusResponse]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
    body: QueueStatusRequest,
) -> ApiTextErrorResponse | ManagementAPIErrorResponse | QueueStatusResponse | None:
    """
    Args:
        id (UUID):
        body (QueueStatusRequest):
