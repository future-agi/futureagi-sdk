...
from ...models.list_personas_response_200 import ListPersonasResponse200
...
) -> ApiErrorWithDetailsResponse | ListPersonasResponse200 | ManagementAPIErrorResponse:
    if response.status_code == 200:
        response_200 = ListPersonasResponse200.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ApiErrorWithDetailsResponse | ListPersonasResponse200 | ManagementAPIErrorResponse]
    """
