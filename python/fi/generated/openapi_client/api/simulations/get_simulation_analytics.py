...
from ...models.sdk_simulation_analytics_response import SDKSimulationAnalyticsResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SDKSimulationAnalyticsResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ManagementAPIErrorResponse | SDKErrorResponse | SDKSimulationAnalyticsResponse]
    """
