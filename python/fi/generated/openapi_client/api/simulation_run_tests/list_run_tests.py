...
from ...models.list_run_tests_simulation_type import ListRunTestsSimulationType
...
def _get_kwargs(
    *,
    search: str | Unset = "",
    simulation_type: ListRunTestsSimulationType | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        simulation_type (ListRunTestsSimulationType | Unset):
