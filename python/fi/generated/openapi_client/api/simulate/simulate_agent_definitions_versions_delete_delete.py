...
from ...models.agent_version_delete_response import AgentVersionDeleteResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/simulate/agent-definitions/{agent_id}/versions/{version_id}/delete/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = AgentVersionDeleteResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[AgentVersionDeleteResponse | ApiErrorWithDetailsResponse | ManagementAPIErrorResponse]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        AgentVersionDeleteResponse | ApiErrorWithDetailsResponse | ManagementAPIErrorResponse
    """
