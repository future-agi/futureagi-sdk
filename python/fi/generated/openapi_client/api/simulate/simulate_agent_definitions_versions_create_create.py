...
from ...models.agent_version_create_response import AgentVersionCreateResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/simulate/agent-definitions/{agent_id}/versions/create/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = AgentVersionCreateResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[AgentVersionCreateResponse | ApiErrorWithDetailsResponse | ManagementAPIErrorResponse]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        AgentVersionCreateResponse | ApiErrorWithDetailsResponse | ManagementAPIErrorResponse
    """
