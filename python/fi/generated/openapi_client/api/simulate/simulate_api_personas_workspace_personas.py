...
from ...models.simulate_api_personas_workspace_personas_response_200 import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SimulateApiPersonasWorkspacePersonasResponse200.from_dict(
            response.json()
        )
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ApiErrorWithDetailsResponse | ManagementAPIErrorResponse | SimulateApiPersonasWorkspacePersonasResponse200]
    """
