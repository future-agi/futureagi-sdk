...
from ...models.run_test_chat_execution_response import RunTestChatExecutionResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/simulate/run-tests/{run_test_id}/chat-execute/".format(
...
) -> ApiTextErrorResponse | ManagementAPIErrorResponse | RunTestChatExecutionResponse:
    if response.status_code == 200:
        response_200 = RunTestChatExecutionResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ApiTextErrorResponse | ManagementAPIErrorResponse | RunTestChatExecutionResponse]
    """
