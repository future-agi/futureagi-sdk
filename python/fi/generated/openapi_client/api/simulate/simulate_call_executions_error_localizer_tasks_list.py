...
from ...models.call_execution_error_localizer_tasks_response import (
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/simulate/call-executions/{call_execution_id}/error-localizer-tasks/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CallExecutionErrorLocalizerTasksResponse.from_dict(
            response.json()
        )
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[CallExecutionErrorLocalizerTasksResponse | CallExecutionErrorResponse | ManagementAPIErrorResponse]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        CallExecutionErrorLocalizerTasksResponse | CallExecutionErrorResponse | ManagementAPIErrorResponse
    """
