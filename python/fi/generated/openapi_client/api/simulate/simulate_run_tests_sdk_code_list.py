...
from ...models.chat_sdk_code_response import ChatSDKCodeResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/simulate/run-tests/{run_test_id}/sdk-code/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ChatSDKCodeResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> ApiTextErrorResponse | ChatSDKCodeResponse | ManagementAPIErrorResponse | None:
    """Get the SDK code with placeholders filled
