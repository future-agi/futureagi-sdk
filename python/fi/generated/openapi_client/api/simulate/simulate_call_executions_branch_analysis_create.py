...
from ...models.call_branch_deviation_create_response import (
...
) -> CallBranchDeviationCreateResponse | ErrorResponse | ManagementAPIErrorResponse:
    if response.status_code == 200:
        response_200 = CallBranchDeviationCreateResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[CallBranchDeviationCreateResponse | ErrorResponse | ManagementAPIErrorResponse]
    """
