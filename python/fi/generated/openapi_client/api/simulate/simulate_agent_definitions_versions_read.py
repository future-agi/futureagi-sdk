...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/simulate/agent-definitions/{agent_id}/versions/{version_id}/".format(
...
) -> AgentVersionResponse | ApiErrorWithDetailsResponse | ManagementAPIErrorResponse:
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[AgentVersionResponse | ApiErrorWithDetailsResponse | ManagementAPIErrorResponse]
    """
