...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/simulate/api/personas/{id}/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 403:
        response_403 = ApiErrorWithDetailsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorWithDetailsResponse | ManagementAPIErrorResponse | Persona]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
    body: Persona,
) -> ApiErrorWithDetailsResponse | ManagementAPIErrorResponse | Persona | None:
    """Update a persona (workspace-level only)
