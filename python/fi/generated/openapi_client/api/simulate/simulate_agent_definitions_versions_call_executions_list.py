...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/simulate/agent-definitions/{agent_id}/versions/{version_id}/call-executions/".format(
...
) -> ApiErrorWithDetailsResponse | ManagementAPIErrorResponse | list[CallExecution]:
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ApiErrorWithDetailsResponse | ManagementAPIErrorResponse | list[CallExecution]]
    """
