...
from ...models.call_execution_detail import CallExecutionDetail
...
) -> CallExecutionDetail | CallExecutionErrorResponse | ManagementAPIErrorResponse:
    if response.status_code == 200:
        response_200 = CallExecutionDetail.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[CallExecutionDetail | CallExecutionErrorResponse | ManagementAPIErrorResponse]
    """
...
def sync(
    ...
    *,
    ...
    CallExecutionDetail | CallExecutionErrorResponse | ManagementAPIErrorResponse | None
):
    """Get a specific call execution with all its details
