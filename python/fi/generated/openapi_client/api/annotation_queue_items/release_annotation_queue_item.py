...
from ...models.queue_release_reservation_response import QueueReleaseReservationResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/annotation-queues/{queue_id}/items/{id}/release/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    ApiTextErrorResponse | ManagementAPIErrorResponse | QueueReleaseReservationResponse
):
    if response.status_code == 200:
        response_200 = QueueReleaseReservationResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ApiTextErrorResponse | ManagementAPIErrorResponse | QueueReleaseReservationResponse]
    """
