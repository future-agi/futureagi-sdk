...
from ...models.queue_submit_annotations_response import QueueSubmitAnnotationsResponse
from ...models.submit_annotations import SubmitAnnotations
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/annotation-queues/{queue_id}/items/{id}/annotations/submit/".format(
...
) -> ApiTextErrorResponse | ManagementAPIErrorResponse | QueueSubmitAnnotationsResponse:
    if response.status_code == 200:
        response_200 = QueueSubmitAnnotationsResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ApiTextErrorResponse | ManagementAPIErrorResponse | QueueSubmitAnnotationsResponse]
    """
