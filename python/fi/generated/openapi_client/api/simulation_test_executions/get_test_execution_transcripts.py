...
from ...models.test_execution_transcripts_response import (
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/simulate/test-executions/{test_execution_id}/transcripts/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = TestExecutionTranscriptsResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    ErrorResponse | ManagementAPIErrorResponse | TestExecutionTranscriptsResponse | None
):
    """Get all transcripts for a test execution
