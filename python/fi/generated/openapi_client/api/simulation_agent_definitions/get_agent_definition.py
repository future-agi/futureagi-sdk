...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/simulate/agent-definitions/{agent_id}/".format(
...
) -> AgentDefinitionResponse | ApiErrorWithDetailsResponse | ManagementAPIErrorResponse:
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[AgentDefinitionResponse | ApiErrorWithDetailsResponse | ManagementAPIErrorResponse]
    """
