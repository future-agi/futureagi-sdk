...
from ...models.experiment_stats_response import ExperimentStatsResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/model-hub/experiments/v2/{experiment_id}/stats/".format(
...
) -> ExperimentStatsResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = ExperimentStatsResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ExperimentStatsResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    ...
    *,
    ...
    ExperimentStatsResponse | ManagementAPIErrorResponse | ModelHubErrorResponse | None
):
    """Stats view for V2 experiments that read from snapshot_dataset.
