...
from ...models.experiment_rerun_request import ExperimentRerunRequest
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    ExperimentStringResultResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
):
    if response.status_code == 200:
        response_200 = ExperimentStringResultResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ExperimentStringResultResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
