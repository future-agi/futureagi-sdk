...
from ...models.experiment_comparison_weights_request import (
    ExperimentComparisonWeightsRequest,
)
from ...models.experiment_dataset_comparison_response import (
...
def _get_kwargs(
    experiment_id: str,
    *,
    body: ExperimentComparisonWeightsRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/experiments/v2/{experiment_id}/compare-experiments/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ExperimentDatasetComparisonResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ExperimentDatasetComparisonResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        ExperimentDatasetComparisonResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
    """
