...
from ...models.experiment_update_v2 import ExperimentUpdateV2
from ...models.experiment_v2_detail_response import ExperimentV2DetailResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/model-hub/experiments/v2/{experiment_id}/".format(
...
) -> ExperimentV2DetailResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = ExperimentV2DetailResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ExperimentV2DetailResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
