...
from ...models.experiment_json_schema_response import ExperimentJsonSchemaResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/model-hub/experiments/v2/{experiment_id}/json-schema/".format(
...
) -> ExperimentJsonSchemaResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = ExperimentJsonSchemaResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ExperimentJsonSchemaResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
