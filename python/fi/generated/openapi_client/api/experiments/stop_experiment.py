...
from ...models.experiment_stop_response import ExperimentStopResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/experiments/v2/{experiment_id}/stop/".format(
...
) -> ExperimentStopResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = ExperimentStopResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ExperimentStopResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
    body: ModelHubEmptyRequest,
) -> ExperimentStopResponse | ManagementAPIErrorResponse | ModelHubErrorResponse | None:
    """Stop a running V2 experiment.
