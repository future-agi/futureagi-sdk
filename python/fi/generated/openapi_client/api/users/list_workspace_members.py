...
from ...models.list_workspace_members_filter_status_item import (
    ListWorkspaceMembersFilterStatusItem,
)
from ...models.list_workspace_members_sort import ListWorkspaceMembersSort
...
def _get_kwargs(
    ...
    *,
    ...
    limit: int | Unset = 20,
    search: str | Unset = "",
    filter_status: list[ListWorkspaceMembersFilterStatusItem] | Unset = UNSET,
    filter_role: list[str] | Unset = UNSET,
    sort: ListWorkspaceMembersSort | Unset = ListWorkspaceMembersSort.VALUE_11,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/accounts/workspace/{workspace_id}/members/".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        filter_status (list[ListWorkspaceMembersFilterStatusItem] | Unset):
        filter_role (list[str] | Unset):
        sort (ListWorkspaceMembersSort | Unset):  Default: ListWorkspaceMembersSort.VALUE_11.
