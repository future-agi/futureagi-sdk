...
from ...models.experiment_rerun_cells import ExperimentRerunCells
from ...models.experiment_workflow_response import ExperimentWorkflowResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/experiments/v2/{experiment_id}/rerun-cells/".format(
...
) -> ExperimentWorkflowResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = ExperimentWorkflowResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ExperimentWorkflowResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
