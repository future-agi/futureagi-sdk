...
from ...models.eval_template_create_response import EvalTemplateCreateResponse
...
) -> EvalTemplateCreateResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = EvalTemplateCreateResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[EvalTemplateCreateResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
