...
from ...models.synthetic_dataset_config import SyntheticDatasetConfig
from ...models.synthetic_dataset_update_response import SyntheticDatasetUpdateResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/model-hub/develops/{dataset_id}/update-synthetic-config/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SyntheticDatasetUpdateResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ManagementAPIErrorResponse | ModelHubErrorResponse | SyntheticDatasetUpdateResponse]
    """
