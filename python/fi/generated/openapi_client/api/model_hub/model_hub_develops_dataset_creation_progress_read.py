...
from ...models.dataset_creation_progress_response import DatasetCreationProgressResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/model-hub/develops/dataset-creation-progress/{dataset_id}/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    DatasetCreationProgressResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
):
    if response.status_code == 200:
        response_200 = DatasetCreationProgressResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[DatasetCreationProgressResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
