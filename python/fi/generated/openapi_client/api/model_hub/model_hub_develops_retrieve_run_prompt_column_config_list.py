...
from ...models.run_prompt_column_config_response import RunPromptColumnConfigResponse
...
) -> ManagementAPIErrorResponse | ModelHubErrorResponse | RunPromptColumnConfigResponse:
    if response.status_code == 200:
        response_200 = RunPromptColumnConfigResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ManagementAPIErrorResponse | ModelHubErrorResponse | RunPromptColumnConfigResponse]
    """
