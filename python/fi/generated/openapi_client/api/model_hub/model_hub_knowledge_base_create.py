...
from ...models.legacy_knowledge_base_create_response import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = LegacyKnowledgeBaseCreateResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[LegacyKnowledgeBaseCreateResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    *,
    ...
    Returns:
        LegacyKnowledgeBaseCreateResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
    """
