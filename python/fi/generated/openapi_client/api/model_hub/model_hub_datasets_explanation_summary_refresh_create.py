...
from ...models.dataset_explanation_summary_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/datasets/explanation-summary/{dataset_id}/refresh/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = DatasetExplanationSummaryResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[DatasetExplanationSummaryResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        DatasetExplanationSummaryResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
    """
