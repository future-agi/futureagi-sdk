...
from ...models.model_hub_prompt_labels_list_response_200 import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ModelHubPromptLabelsListResponse200.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ManagementAPIErrorResponse | ModelHubPromptLabelsListResponse200 | ModelHubTextErrorResponse]
    """
...
def sync(
    *,
    ...
    Returns:
        ManagementAPIErrorResponse | ModelHubPromptLabelsListResponse200 | ModelHubTextErrorResponse
    """
