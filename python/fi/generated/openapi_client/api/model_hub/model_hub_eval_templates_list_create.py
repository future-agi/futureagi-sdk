...
from ...models.eval_list_request import EvalListRequest
from ...models.eval_template_list_response import EvalTemplateListResponse
...
) -> EvalTemplateListResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = EvalTemplateListResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[EvalTemplateListResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    *,
    ...
    EvalTemplateListResponse | ManagementAPIErrorResponse | ModelHubErrorResponse | None
):
    """POST /model-hub/eval-templates/list/
