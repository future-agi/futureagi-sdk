...
from ...models.delete_eval_template import DeleteEvalTemplate
from ...models.management_api_error_response import ManagementAPIErrorResponse
from ...models.model_hub_error_response import ModelHubErrorResponse
from ...models.model_hub_string_result_response import ModelHubStringResultResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ModelHubStringResultResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ManagementAPIErrorResponse | ModelHubErrorResponse | ModelHubStringResultResponse]
    """
