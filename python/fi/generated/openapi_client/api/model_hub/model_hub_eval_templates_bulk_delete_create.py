...
from ...models.eval_template_bulk_delete_request import EvalTemplateBulkDeleteRequest
from ...models.eval_template_bulk_delete_response import EvalTemplateBulkDeleteResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    EvalTemplateBulkDeleteResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
):
    if response.status_code == 200:
        response_200 = EvalTemplateBulkDeleteResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[EvalTemplateBulkDeleteResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
