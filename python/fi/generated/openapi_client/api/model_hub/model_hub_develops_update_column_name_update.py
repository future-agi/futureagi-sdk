...
from ...models.dataset_update_column_name_request import DatasetUpdateColumnNameRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/model-hub/develops/{dataset_id}/update_column_name/{column_id}/".format(
