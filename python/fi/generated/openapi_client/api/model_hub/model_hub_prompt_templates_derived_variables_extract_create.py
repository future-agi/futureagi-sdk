...
from ...models.derived_variable_extract_request import DerivedVariableExtractRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/prompt-templates/{prompt_id}/derived-variables/extract/".format(
