...
from ...models.composite_eval_adhoc_execute_request import (
    CompositeEvalAdhocExecuteRequest,
)
from ...models.composite_eval_execute_response import CompositeEvalExecuteResponse
...
) -> CompositeEvalExecuteResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = CompositeEvalExecuteResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[CompositeEvalExecuteResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
