...
from ...models.experiment_feedback_submit_request import ExperimentFeedbackSubmitRequest
from ...models.experiment_feedback_submit_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/experiments/v2/{experiment_id}/feedback/submit-feedback/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ExperimentFeedbackSubmitResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ExperimentFeedbackSubmitResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        ExperimentFeedbackSubmitResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
    """
