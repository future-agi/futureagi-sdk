...
from ...models.experiment_evaluation_stats_response import (
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/model-hub/experiments/v2/{experiment_id}/evaluations/{evaluation_id}/stats/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ExperimentEvaluationStatsResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ExperimentEvaluationStatsResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        ExperimentEvaluationStatsResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
    """
