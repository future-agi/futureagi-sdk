...
from ...models.eval_template_detail_response import EvalTemplateDetailResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/model-hub/eval-templates/{template_id}/detail/".format(
...
) -> EvalTemplateDetailResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = EvalTemplateDetailResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[EvalTemplateDetailResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
