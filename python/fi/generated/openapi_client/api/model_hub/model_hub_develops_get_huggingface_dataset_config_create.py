...
from ...models.hugging_face_dataset_config_request import (
    HuggingFaceDatasetConfigRequest,
)
from ...models.hugging_face_dataset_config_response import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = HuggingFaceDatasetConfigResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[HuggingFaceDatasetConfigResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    *,
    ...
    Returns:
        HuggingFaceDatasetConfigResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
    """
