...
) -> Any | ManagementAPIErrorResponse | ModelHubTextErrorResponse:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ManagementAPIErrorResponse | ModelHubTextErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> Any | ManagementAPIErrorResponse | ModelHubTextErrorResponse | None:
    """
    Args:
        id (str):
