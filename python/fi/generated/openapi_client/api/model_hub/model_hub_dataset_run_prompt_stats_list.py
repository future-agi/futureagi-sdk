...
from ...models.dataset_run_prompt_stats_response import DatasetRunPromptStatsResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/model-hub/dataset/{dataset_id}/run-prompt-stats/".format(
...
) -> DatasetRunPromptStatsResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = DatasetRunPromptStatsResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[DatasetRunPromptStatsResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
