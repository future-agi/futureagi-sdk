...
from ...models.user_eval_mutation_request import UserEvalMutationRequest
...
def _get_kwargs(
    dataset_id: str,
    *,
    body: UserEvalMutationRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/develops/{dataset_id}/add_user_eval/".format(
