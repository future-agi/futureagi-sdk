...
from ...models.ground_truth_upload_request import GroundTruthUploadRequest
from ...models.ground_truth_upload_response import GroundTruthUploadResponse
...
def _get_kwargs(
    template_id: str,
    *,
    body: GroundTruthUploadRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/eval-templates/{template_id}/ground-truth/upload/".format(
...
) -> GroundTruthUploadResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = GroundTruthUploadResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[GroundTruthUploadResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
