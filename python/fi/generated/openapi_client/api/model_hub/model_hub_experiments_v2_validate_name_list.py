...
from ...models.experiment_name_validation_response import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ExperimentNameValidationResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ExperimentNameValidationResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    *,
    ...
    Returns:
        ExperimentNameValidationResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
    """
