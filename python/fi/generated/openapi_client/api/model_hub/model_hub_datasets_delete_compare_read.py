...
from ...models.compare_dataset_row_response import CompareDatasetRowResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/model-hub/datasets/delete-compare/{compare_id}/".format(
...
) -> CompareDatasetRowResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = CompareDatasetRowResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[CompareDatasetRowResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
