...
from ...models.hugging_face_dataset_detail_request import (
    HuggingFaceDatasetDetailRequest,
)
from ...models.hugging_face_dataset_detail_response import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = HuggingFaceDatasetDetailResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[HuggingFaceDatasetDetailResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    *,
    ...
    Returns:
        HuggingFaceDatasetDetailResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
    """
