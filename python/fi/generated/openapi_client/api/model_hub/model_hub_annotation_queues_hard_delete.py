...
from ...models.queue_hard_delete_request import QueueHardDeleteRequest
from ...models.queue_hard_delete_response import QueueHardDeleteResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/annotation-queues/{id}/hard-delete/".format(
...
) -> ApiTextErrorResponse | ManagementAPIErrorResponse | QueueHardDeleteResponse:
    if response.status_code == 200:
        response_200 = QueueHardDeleteResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[ApiTextErrorResponse | ManagementAPIErrorResponse | QueueHardDeleteResponse]
    """
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
    body: QueueHardDeleteRequest,
) -> ApiTextErrorResponse | ManagementAPIErrorResponse | QueueHardDeleteResponse | None:
    """Permanently remove a queue + everything attached.
