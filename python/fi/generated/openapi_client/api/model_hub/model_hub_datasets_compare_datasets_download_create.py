...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/datasets/{dataset_id}/compare-datasets/download/".format(
...
) -> File | ManagementAPIErrorResponse | ModelHubErrorResponse:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[File | ManagementAPIErrorResponse | ModelHubErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
    body: CompareDataset,
) -> File | ManagementAPIErrorResponse | ModelHubErrorResponse | None:
    """
    Args:
        dataset_id (str):
        body (CompareDataset):
