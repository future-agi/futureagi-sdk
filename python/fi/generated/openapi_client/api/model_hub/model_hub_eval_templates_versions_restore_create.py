...
from ...models.eval_template_version_restore_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/eval-templates/{template_id}/versions/{version_id}/restore/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = EvalTemplateVersionRestoreResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[EvalTemplateVersionRestoreResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        EvalTemplateVersionRestoreResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
    """
