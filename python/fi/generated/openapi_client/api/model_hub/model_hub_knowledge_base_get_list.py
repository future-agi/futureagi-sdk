...
from ...models.legacy_knowledge_base_table_response import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = LegacyKnowledgeBaseTableResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[LegacyKnowledgeBaseTableResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    *,
    ...
    Returns:
        LegacyKnowledgeBaseTableResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
    """
