...
from ...models.legacy_knowledge_base_sdk_code_response import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = LegacyKnowledgeBaseSdkCodeResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[LegacyKnowledgeBaseSdkCodeResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
...
def sync(
    *,
    ...
    Returns:
        LegacyKnowledgeBaseSdkCodeResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
    """
