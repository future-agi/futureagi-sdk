...
from ...models.create_dataset_from_experiment_request import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/develops/{exp_dataset_id}/create-dataset/".format(
            exp_dataset_id=quote(str(exp_dataset_id), safe=""),
        ),
    }
