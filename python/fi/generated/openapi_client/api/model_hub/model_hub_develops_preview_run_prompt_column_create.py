...
from ...models.preview_run_prompt import PreviewRunPrompt
from ...models.run_prompt_column_preview_response import RunPromptColumnPreviewResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = RunPromptColumnPreviewResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ManagementAPIErrorResponse | ModelHubErrorResponse | RunPromptColumnPreviewResponse]
    """
