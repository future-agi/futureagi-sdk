...
from ...models.compare_dataset_stats_request import CompareDatasetStatsRequest
from ...models.compare_dataset_stats_response import CompareDatasetStatsResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/model-hub/datasets/{dataset_id}/compare-stats/".format(
...
) -> CompareDatasetStatsResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = CompareDatasetStatsResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[CompareDatasetStatsResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
