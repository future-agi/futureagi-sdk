...
from ...models.hugging_face_dataset_list_request import HuggingFaceDatasetListRequest
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    HuggingFaceDatasetListResponse | ManagementAPIErrorResponse | ModelHubErrorResponse
):
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[HuggingFaceDatasetListResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
