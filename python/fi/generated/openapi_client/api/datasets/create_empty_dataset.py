...
from ...models.create_empty_dataset_request import CreateEmptyDatasetRequest
from ...models.dataset_create_started_response import DatasetCreateStartedResponse
...
) -> DatasetCreateStartedResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = DatasetCreateStartedResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[DatasetCreateStartedResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
