...
from ...models.dataset_column_detail_response import DatasetColumnDetailResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/model-hub/dataset/columns/{dataset_id}/".format(
...
) -> DatasetColumnDetailResponse | ManagementAPIErrorResponse | ModelHubErrorResponse:
    if response.status_code == 200:
        response_200 = DatasetColumnDetailResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[DatasetColumnDetailResponse | ManagementAPIErrorResponse | ModelHubErrorResponse]
    """
