...
T = TypeVar("T", bound="ModelHubPromptLabelsTemplateLabelsResponse200")


@_attrs_define
class ModelHubPromptLabelsTemplateLabelsResponse200:
    """
    Attributes:
        count (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_hub_prompt_labels_template_labels_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        model_hub_prompt_labels_template_labels_response_200.additional_properties = d
