...
T = TypeVar("T", bound="SimulatorAgentListResponse")


@_attrs_define
class SimulatorAgentListResponse:
    """
    Attributes:
        count (int | Unset):
        next_ (None | str | Unset):
        previous (None | str | Unset):
        results (list[SimulatorAgent] | Unset):
    ...
    results: list[SimulatorAgent] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            ...
            for results_item_data in _results:
                results_item = SimulatorAgent.from_dict(results_item_data)
        ...
        simulator_agent_list_response = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        return simulator_agent_list_response
