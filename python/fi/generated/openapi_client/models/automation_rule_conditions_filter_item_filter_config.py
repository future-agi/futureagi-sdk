...
T = TypeVar("T", bound="AutomationRuleConditionsFilterItemFilterConfig")


@_attrs_define
class AutomationRuleConditionsFilterItemFilterConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        automation_rule_conditions_filter_item_filter_config = cls(
            filter_type=filter_type,
            filter_op=filter_op,
        ...
        return automation_rule_conditions_filter_item_filter_config
