...
T = TypeVar("T", bound="AgentDefinitionEditResponse")


@_attrs_define
class AgentDefinitionEditResponse:
    """
    Attributes:
        message (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_definition_edit_response = cls(
            message=message,
            agent=agent,
        )

        agent_definition_edit_response.additional_properties = d
        return agent_definition_edit_response
