...
T = TypeVar("T", bound="TracerTraceListResponse200")


@_attrs_define
class TracerTraceListResponse200:
    """
    Attributes:
        count (int):
        results (list[Trace]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tracer_trace_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        tracer_trace_list_response_200.additional_properties = d
        return tracer_trace_list_response_200
