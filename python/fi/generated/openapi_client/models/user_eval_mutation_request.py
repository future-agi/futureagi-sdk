...
if TYPE_CHECKING:
    from ..models.user_eval_mutation_request_composite_weight_overrides import (
        UserEvalMutationRequestCompositeWeightOverrides,
    )
    from ..models.user_eval_mutation_request_config import UserEvalMutationRequestConfig


T = TypeVar("T", bound="UserEvalMutationRequest")


@_attrs_define
class UserEvalMutationRequest:
    """
    Attributes:
        name (str):
        template_id (str):
        config (UserEvalMutationRequestConfig):
        kb_id (UUID | Unset):
        ...
        composite_weight_overrides (UserEvalMutationRequestCompositeWeightOverrides | Unset):
    """
    ...
    composite_weight_overrides: (
        UserEvalMutationRequestCompositeWeightOverrides | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.user_eval_mutation_request_config import (
        ...
        config = UserEvalMutationRequestConfig.from_dict(d.pop("config"))
        ...
        if isinstance(_composite_weight_overrides, Unset):
            ...
            composite_weight_overrides = (
                UserEvalMutationRequestCompositeWeightOverrides.from_dict(
                    _composite_weight_overrides
                )
            )

        user_eval_mutation_request = cls(
            name=name,
            template_id=template_id,
            config=config,
            kb_id=kb_id,
        ...
        user_eval_mutation_request.additional_properties = d
        return user_eval_mutation_request
