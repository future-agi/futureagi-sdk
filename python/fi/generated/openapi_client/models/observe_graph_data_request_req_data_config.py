...
from ..models.observe_graph_data_request_req_data_config_type import (
    ObserveGraphDataRequestReqDataConfigType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ObserveGraphDataRequestReqDataConfig")


@_attrs_define
class ObserveGraphDataRequestReqDataConfig:
    """
    Attributes:
        id (str):
        type_ (ObserveGraphDataRequestReqDataConfigType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ObserveGraphDataRequestReqDataConfigType(d.pop("type"))
        ...
        observe_graph_data_request_req_data_config = cls(
            id=id,
            type_=type_,
        ...
        return observe_graph_data_request_req_data_config
