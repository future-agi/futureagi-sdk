...
from ..models.execution_runs_status import ExecutionRunsStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExecutionRuns")
...
class ExecutionRuns:
    ...
    Attributes:
        execution_id (UUID):
        status (ExecutionRunsStatus | Unset): Current status of the test execution
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: ExecutionRunsStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = ExecutionRunsStatus(_status)
        ...
        eval_results = d.pop("eval_results", UNSET)
        ...
        execution_runs.additional_properties = d
