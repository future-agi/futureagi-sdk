...
T = TypeVar("T", bound="AgentFlowGraphNodesItem")
...
class AgentFlowGraphNodesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        agent_flow_graph_nodes_item = cls()
        ...
        agent_flow_graph_nodes_item.additional_properties = additional_properties
        return agent_flow_graph_nodes_item
