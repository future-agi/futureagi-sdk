...
T = TypeVar("T", bound="SelectionFilterItemFilterConfig")


@_attrs_define
class SelectionFilterItemFilterConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        selection_filter_item_filter_config = cls(
            filter_type=filter_type,
            filter_op=filter_op,
        ...
        return selection_filter_item_filter_config
