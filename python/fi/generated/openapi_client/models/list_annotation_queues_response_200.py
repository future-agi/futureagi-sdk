...
T = TypeVar("T", bound="ListAnnotationQueuesResponse200")


@_attrs_define
class ListAnnotationQueuesResponse200:
    """
    Attributes:
        count (int):
        results (list[AnnotationQueue]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = AnnotationQueue.from_dict(results_item_data)
        ...
        list_annotation_queues_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        list_annotation_queues_response_200.additional_properties = d
        return list_annotation_queues_response_200
