...
from ..models.agent_definition_edit_request_agent_type import (
    AgentDefinitionEditRequestAgentType,
)
from ..models.agent_definition_edit_request_authentication_method import (
    AgentDefinitionEditRequestAuthenticationMethod,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.agent_definition_edit_request_livekit_config_json import (
        AgentDefinitionEditRequestLivekitConfigJson,
    )
    from ..models.agent_definition_edit_request_model_details import (
        AgentDefinitionEditRequestModelDetails,
    )
    from ..models.agent_definition_edit_request_websocket_headers import (
        AgentDefinitionEditRequestWebsocketHeaders,
    )


T = TypeVar("T", bound="AgentDefinitionEditRequest")


@_attrs_define
class AgentDefinitionEditRequest:
    """
    Attributes:
        agent_name (str | Unset):
        agent_type (AgentDefinitionEditRequestAgentType | Unset):
        description (None | str | Unset):
        provider (None | str | Unset):
        api_key (None | str | Unset):
        assistant_id (None | str | Unset):
        authentication_method (AgentDefinitionEditRequestAuthenticationMethod | Unset):
        ...
        model_details (AgentDefinitionEditRequestModelDetails | Unset):
        websocket_url (None | str | Unset):
        websocket_headers (AgentDefinitionEditRequestWebsocketHeaders | Unset):
        ...
        livekit_config_json (AgentDefinitionEditRequestLivekitConfigJson | Unset):
        livekit_max_concurrency (int | None | Unset):
    """

    agent_name: str | Unset = UNSET
    agent_type: AgentDefinitionEditRequestAgentType | Unset = UNSET
    ...
    model_details: AgentDefinitionEditRequestModelDetails | Unset = UNSET
    websocket_url: None | str | Unset = UNSET
    websocket_headers: AgentDefinitionEditRequestWebsocketHeaders | Unset = UNSET
    ...
    livekit_config_json: AgentDefinitionEditRequestLivekitConfigJson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_agent_type, Unset):
            ...
            agent_type = AgentDefinitionEditRequestAgentType(_agent_type)
        ...
        if isinstance(_authentication_method, Unset):
            ...
            authentication_method = AgentDefinitionEditRequestAuthenticationMethod(
        ...
        if isinstance(_model_details, Unset):
            ...
            model_details = AgentDefinitionEditRequestModelDetails.from_dict(
                _model_details
            )
        ...
        if isinstance(_websocket_headers, Unset):
            ...
            websocket_headers = AgentDefinitionEditRequestWebsocketHeaders.from_dict(
                _websocket_headers
            )
        ...
        if isinstance(_livekit_config_json, Unset):
            ...
            livekit_config_json = AgentDefinitionEditRequestLivekitConfigJson.from_dict(
        ...
        agent_definition_edit_request = cls(
        ...
        agent_definition_edit_request.additional_properties = d
        return agent_definition_edit_request
