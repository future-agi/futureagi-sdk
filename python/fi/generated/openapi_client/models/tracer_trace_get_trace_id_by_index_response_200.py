...
@_attrs_define
class TracerTraceGetTraceIdByIndexResponse200:
    """
    Attributes:
        count (int):
        results (list[Trace]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tracer_trace_get_trace_id_by_index_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        tracer_trace_get_trace_id_by_index_response_200.additional_properties = d
