...
T = TypeVar("T", bound="ListVoiceCallsResponse200")


@_attrs_define
class ListVoiceCallsResponse200:
    """
    Attributes:
        count (int):
        results (list[Trace]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_voice_calls_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        list_voice_calls_response_200.additional_properties = d
        return list_voice_calls_response_200
