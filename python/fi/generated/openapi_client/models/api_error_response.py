...
from ..models.api_error_response_type import ApiErrorResponseType
...
class ApiErrorResponse:
    ...
    Attributes:
        ...
        type_ (ApiErrorResponseType | Unset):
        code (None | str | Unset):
    ...
    type_: ApiErrorResponseType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = ApiErrorResponseType(_type_)
