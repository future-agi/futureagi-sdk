...
T = TypeVar("T", bound="AgentVersionCreateResponse")


@_attrs_define
class AgentVersionCreateResponse:
    """
    Attributes:
        message (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_version_create_response = cls(
            message=message,
            version=version,
        )

        agent_version_create_response.additional_properties = d
        return agent_version_create_response
