...
T = TypeVar("T", bound="ModelHubAnnotationQueuesAutomationRulesListResponse200")
...
class ModelHubAnnotationQueuesAutomationRulesListResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = AutomationRule.from_dict(results_item_data)
        ...
        model_hub_annotation_queues_automation_rules_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        model_hub_annotation_queues_automation_rules_list_response_200.additional_properties = d
