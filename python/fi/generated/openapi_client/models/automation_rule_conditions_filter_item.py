...
if TYPE_CHECKING:
    from ..models.automation_rule_conditions_filter_item_filter_config import (
        AutomationRuleConditionsFilterItemFilterConfig,
    )


T = TypeVar("T", bound="AutomationRuleConditionsFilterItem")


@_attrs_define
class AutomationRuleConditionsFilterItem:
    """
    Attributes:
        column_id (str): Column or attribute id to filter on.
        filter_config (AutomationRuleConditionsFilterItemFilterConfig):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_config = AutomationRuleConditionsFilterItemFilterConfig.from_dict(
            d.pop("filter_config")
        )
        ...
        automation_rule_conditions_filter_item = cls(
            column_id=column_id,
            filter_config=filter_config,
        ...
        return automation_rule_conditions_filter_item
