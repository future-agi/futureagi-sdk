...
T = TypeVar("T", bound="SimulateApiPersonasWorkspacePersonasResponse200")


@_attrs_define
class SimulateApiPersonasWorkspacePersonasResponse200:
    """
    Attributes:
        count (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        simulate_api_personas_workspace_personas_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        simulate_api_personas_workspace_personas_response_200.additional_properties = d
