...
if TYPE_CHECKING:
    from ..models.simulate_eval_config_response_filters_item_filter_config import (
        SimulateEvalConfigResponseFiltersItemFilterConfig,
    )


T = TypeVar("T", bound="SimulateEvalConfigResponseFiltersItem")


@_attrs_define
class SimulateEvalConfigResponseFiltersItem:
    """
    Attributes:
        column_id (str): Column or attribute id to filter on.
        filter_config (SimulateEvalConfigResponseFiltersItemFilterConfig):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_config = SimulateEvalConfigResponseFiltersItemFilterConfig.from_dict(
            d.pop("filter_config")
        )
        ...
        simulate_eval_config_response_filters_item = cls(
            column_id=column_id,
            filter_config=filter_config,
        ...
        return simulate_eval_config_response_filters_item
