...
T = TypeVar("T", bound="TraceSessionGraphDataRequestFiltersItemFilterConfig")


@_attrs_define
class TraceSessionGraphDataRequestFiltersItemFilterConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trace_session_graph_data_request_filters_item_filter_config = cls(
            filter_type=filter_type,
            filter_op=filter_op,
        ...
        return trace_session_graph_data_request_filters_item_filter_config
