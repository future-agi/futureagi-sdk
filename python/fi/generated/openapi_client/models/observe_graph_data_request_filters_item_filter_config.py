...
T = TypeVar("T", bound="ObserveGraphDataRequestFiltersItemFilterConfig")


@_attrs_define
class ObserveGraphDataRequestFiltersItemFilterConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        observe_graph_data_request_filters_item_filter_config = cls(
            filter_type=filter_type,
            filter_op=filter_op,
        ...
        return observe_graph_data_request_filters_item_filter_config
