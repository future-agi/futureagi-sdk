...
T = TypeVar("T", bound="GetVoiceCallDetailResponse200")


@_attrs_define
class GetVoiceCallDetailResponse200:
    """
    Attributes:
        count (int):
        results (list[Trace]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_voice_call_detail_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        get_voice_call_detail_response_200.additional_properties = d
        return get_voice_call_detail_response_200
