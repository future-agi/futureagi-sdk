...
T = TypeVar("T", bound="RunTestResponseAgentVersion")
...
class RunTestResponseAgentVersion:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        run_test_response_agent_version = cls()
        ...
        run_test_response_agent_version.additional_properties = additional_properties
        return run_test_response_agent_version
