...
T = TypeVar("T", bound="ModelHubScoresListResponse200")


@_attrs_define
class ModelHubScoresListResponse200:
    """
    Attributes:
        count (int):
        results (list[Score]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Score.from_dict(results_item_data)
        ...
        model_hub_scores_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        model_hub_scores_list_response_200.additional_properties = d
        return model_hub_scores_list_response_200
