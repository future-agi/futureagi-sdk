...
T = TypeVar("T", bound="DatasetCreateStartedResult")


@_attrs_define
class DatasetCreateStartedResult:
    """
    Attributes:
        message (str):
        dataset_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_create_started_result = cls(
            message=message,
            dataset_id=dataset_id,
            dataset_name=dataset_name,
        ...
        dataset_create_started_result.additional_properties = d
