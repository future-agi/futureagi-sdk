...
T = TypeVar("T", bound="TestExecutionRerunResultFailedRerunsItem")
...
class TestExecutionRerunResultFailedRerunsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        test_execution_rerun_result_failed_reruns_item = cls()
        ...
        test_execution_rerun_result_failed_reruns_item.additional_properties = (
            additional_properties
        )
        return test_execution_rerun_result_failed_reruns_item
