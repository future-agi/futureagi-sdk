...
T = TypeVar("T", bound="DatasetRowDataRequestFiltersItemFilterConfig")


@_attrs_define
class DatasetRowDataRequestFiltersItemFilterConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_row_data_request_filters_item_filter_config = cls(
            filter_type=filter_type,
            filter_op=filter_op,
        ...
        return dataset_row_data_request_filters_item_filter_config
