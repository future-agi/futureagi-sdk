...
if TYPE_CHECKING:
    from ..models.dataset_row_data_request_filters_item_filter_config import (
...
@_attrs_define
class DatasetRowDataRequestFiltersItem:
    """
    Attributes:
        column_id (str): Column or attribute id to filter on.
        filter_config (DatasetRowDataRequestFiltersItemFilterConfig):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_config = DatasetRowDataRequestFiltersItemFilterConfig.from_dict(
            d.pop("filter_config")
        )
        ...
        dataset_row_data_request_filters_item = cls(
            column_id=column_id,
            filter_config=filter_config,
        ...
        return dataset_row_data_request_filters_item
