...
T = TypeVar("T", bound="ModelHubPromptTemplatesListResponse200")
...
class ModelHubPromptTemplatesListResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_hub_prompt_templates_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        model_hub_prompt_templates_list_response_200.additional_properties = d
