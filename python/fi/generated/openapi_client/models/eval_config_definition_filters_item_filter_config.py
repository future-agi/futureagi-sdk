...
T = TypeVar("T", bound="EvalConfigDefinitionFiltersItemFilterConfig")


@_attrs_define
class EvalConfigDefinitionFiltersItemFilterConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        eval_config_definition_filters_item_filter_config = cls(
            filter_type=filter_type,
            filter_op=filter_op,
        ...
        return eval_config_definition_filters_item_filter_config
