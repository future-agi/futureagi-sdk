...
T = TypeVar("T", bound="ListTraceProjectsResponse200")


@_attrs_define
class ListTraceProjectsResponse200:
    """
    Attributes:
        count (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_trace_projects_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        list_trace_projects_response_200.additional_properties = d
        return list_trace_projects_response_200
