...
if TYPE_CHECKING:
    from ..models.observe_graph_data_request_filters_item_filter_config import (
...
@_attrs_define
class ObserveGraphDataRequestFiltersItem:
    """
    Attributes:
        column_id (str): Column or attribute id to filter on.
        filter_config (ObserveGraphDataRequestFiltersItemFilterConfig):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_config = ObserveGraphDataRequestFiltersItemFilterConfig.from_dict(
            d.pop("filter_config")
        )
        ...
        observe_graph_data_request_filters_item = cls(
            column_id=column_id,
            filter_config=filter_config,
        ...
        return observe_graph_data_request_filters_item
