...
T = TypeVar("T", bound="TracerTraceAgentGraphResponse200")


@_attrs_define
class TracerTraceAgentGraphResponse200:
    """
    Attributes:
        count (int):
        results (list[Trace]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tracer_trace_agent_graph_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        tracer_trace_agent_graph_response_200.additional_properties = d
