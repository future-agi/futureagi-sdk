...
T = TypeVar("T", bound="ScenarioAddRowsResponse")


@_attrs_define
class ScenarioAddRowsResponse:
    """
    Attributes:
        message (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scenario_add_rows_response = cls(
            message=message,
        ...
        scenario_add_rows_response.additional_properties = d
        return scenario_add_rows_response
