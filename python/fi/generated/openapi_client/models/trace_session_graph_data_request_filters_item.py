...
if TYPE_CHECKING:
    from ..models.trace_session_graph_data_request_filters_item_filter_config import (
        TraceSessionGraphDataRequestFiltersItemFilterConfig,
    )


T = TypeVar("T", bound="TraceSessionGraphDataRequestFiltersItem")


@_attrs_define
class TraceSessionGraphDataRequestFiltersItem:
    """
    Attributes:
        column_id (str): Column or attribute id to filter on.
        filter_config (TraceSessionGraphDataRequestFiltersItemFilterConfig):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_config = TraceSessionGraphDataRequestFiltersItemFilterConfig.from_dict(
            d.pop("filter_config")
        )
        ...
        trace_session_graph_data_request_filters_item = cls(
            column_id=column_id,
            filter_config=filter_config,
        ...
        return trace_session_graph_data_request_filters_item
