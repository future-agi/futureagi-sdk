...
T = TypeVar("T", bound="CompareStartEvalsRequest")


@_attrs_define
class CompareStartEvalsRequest:
    """
    Attributes:
        user_eval_names (list[str]):
    ...
    def to_dict(self) -> dict[str, Any]:
        user_eval_names = self.user_eval_names
        ...
        field_dict.update(
            {
                "user_eval_names": user_eval_names,
            }
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        user_eval_names = cast(list[str], d.pop("user_eval_names"))
        ...
        compare_start_evals_request = cls(
            user_eval_names=user_eval_names,
            dataset_ids=dataset_ids,
        )

        compare_start_evals_request.additional_properties = d
        return compare_start_evals_request
