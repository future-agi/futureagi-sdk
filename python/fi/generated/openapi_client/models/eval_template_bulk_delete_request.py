...
T = TypeVar("T", bound="EvalTemplateBulkDeleteRequest")


@_attrs_define
class EvalTemplateBulkDeleteRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        eval_template_bulk_delete_request = cls(
            template_ids=template_ids,
        )

        eval_template_bulk_delete_request.additional_properties = d
        return eval_template_bulk_delete_request
