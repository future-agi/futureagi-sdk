...
if TYPE_CHECKING:
    from ..models.bulk_annotation_record_request import BulkAnnotationRecordRequest
...
class BulkAnnotationRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for records_item_data in _records:
            records_item = BulkAnnotationRecordRequest.from_dict(records_item_data)

            records.append(records_item)

        bulk_annotation_request = cls(
            records=records,
        )
