...
T = TypeVar("T", bound="ClassifyColumnRequest")


@_attrs_define
class ClassifyColumnRequest:
    """
    Attributes:
        column_id (UUID):
        labels (list[str]):
        language_model_id (str | Unset):  Default: 'gpt-4o'.
    ...
    column_id: UUID
    labels: list[str]
    language_model_id: str | Unset = "gpt-4o"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        classify_column_request.additional_properties = d
        return classify_column_request
