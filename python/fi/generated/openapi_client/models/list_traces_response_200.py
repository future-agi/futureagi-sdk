...
T = TypeVar("T", bound="ListTracesResponse200")


@_attrs_define
class ListTracesResponse200:
    """
    Attributes:
        count (int):
        results (list[Trace]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_traces_response_200.additional_properties = d
        return list_traces_response_200
