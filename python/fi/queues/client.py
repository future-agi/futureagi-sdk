...
class AnnotationQueue(APIKeyAuth):
    ...
    def activate(self, queue_id: str, *, timeout: Optional[int] = None) -> QueueDetail:
        ...
        return self._update_status(queue_id, "active", timeout=timeout)
    ...
    def list_items(
        ...
        *,
        ...
        url = f"{self._base_url}/{Routes.queue_items.value}".format(queue_id=queue_id)
    ...
    def create_score(
        ...
        *,
        ...
        Args:
            ...
            label_id: UUID of the annotation label.
